...
void LCD_Command(uint8_t cmd) {
    ...
    if(cmd == 0x01) _delay((unsigned long)((2)*(8000000UL/4000.0)));
    else _delay((unsigned long)((50)*(8000000UL/4000000.0)));
}
...
# 6 "Prog_EAD.c" 2
# 1 "./bib_Ultrasonico.h" 1
# 11 "./bib_Ultrasonico.h"
